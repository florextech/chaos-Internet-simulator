...
![npm CLI](https://img.shields.io/npm/v/@florextech/chaos-net?label=chaos-net%20cli)
...
- `@florextech/chaos-net`

Manual local publish (requires npm auth):

```bash
pnpm --filter @florextech/chaos-net build
pnpm --filter @florextech/chaos-net publish --access public
```
